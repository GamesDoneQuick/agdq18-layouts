(function () {
	...
	class GdqAudioDashboard extends Polymer.MutableData(Polymer.Element) {
		static get is() {
			return 'gdq-audio-dashboard';
		}
	...
	customElements.define(GdqAudioDashboard.is, GdqAudioDashboard);
})();
