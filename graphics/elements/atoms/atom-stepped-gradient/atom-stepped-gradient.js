...
class AtomSteppedGradient extends SteppedGradientMixin(Polymer.Element) {
	static get is() {
		return 'atom-stepped-gradient';
	}
...
customElements.define(AtomSteppedGradient.is, AtomSteppedGradient);
