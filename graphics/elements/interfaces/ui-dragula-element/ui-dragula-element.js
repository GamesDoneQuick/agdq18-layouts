...
class UiDraguleElement extends Polymer.Element {
	static get is() {
		return 'ui-dragula-element';
	}
	...
	static get properties() {
		return {
			 ...
			 * If left undefined, `<ui-dragula-element>` will use itself as container.
			 *
			 ...
			 * To make elements draggable between different `ui-dragula-element`s,
			 * you should data-bind this object to the other `ui-dragula-element`s.
			 *
			 * @attribute drake
			 * @type Boolean
			 */
			...
			/**
			 * If left undefined, `ui-dragula-element` will add itself as container.
...
customElements.define(UiDraguleElement.is, UiDraguleElement);
